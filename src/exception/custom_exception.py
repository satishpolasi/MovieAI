...
class MovieAIException(Exception):
    ...
    def __repr__(self):
        return f"MovieAIException(file={self.file_name!r}, line={self.lineno}, message={self.error_message!r})"
...
#         raise MovieAIException("Division failed", e) from e
