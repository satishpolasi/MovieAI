...
#    logger.info("connect to SQLite successful", db_path="/data/movies.db",  status="success")
#    logger.error("Failed to connect SQlite", error="Database not found", db_path="/data/movies.db")